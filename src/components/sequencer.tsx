...
export const Sequencer: React.FC<{}> = ({ }) => {
  ...
  const song = useSelector((state: AppState) => {
  ...
  const instrumentName = useSelector((state: AppState) => { return state.song.instrumentName; }, shallowEqual);
  const songAction = useSelector((state: AppState) => { return state.song.songAction; }, shallowEqual);
